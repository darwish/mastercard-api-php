...
class TransferServiceTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testTransferRequestCardAccountTest() {
    ...
    public function testPaymentRequestCardAccountTest() {
    ...
    public function testPaymentRequestMappedAccountTest() {
